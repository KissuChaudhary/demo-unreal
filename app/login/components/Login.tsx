            ...
            <div className="mt-6">
              ...
              <div className="mt-6">
                <Button
                  ...
                  className="w-full inline-flex items-center justify-center py-3 px-4 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 border border-gray-300"
                >
                  {isGoogleSigningIn ? (
                    <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                  ) : (
