...
export default function InstagramCaptionGenerator() {
  ...
  return (
    <div className="max-w-7xl mx-auto mt-10">
      ...
      <p className="text-xl text-center text-gray-600 mb-12 max-w-3xl mx-auto">Create engaging Instagram captions with AI - Perfect for boosting your social media presence.</p>
